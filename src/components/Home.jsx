        ...
        <div className="flex flex-col items-center justify-center gap-8 p-5 text-center">
          ...
          <div className="space-y-1 sm:space-y-3">
            ...
            <p className="text-muted">
              {" "}
              Fusce volutpat posuere dolor quis rhoncus. Nullam tortor turpis,
              sodales in lacinia in, consequat et risus. Pellentesque rutrum
              tempus nisl, in tristique ante congue eget. Vestibulum ut ex ac
              justo vulputate ultrices sed vel.
            </p>
          </div>
