    ...
    <div id="projects" className="min-h-screen w-full flex flex-col items-center justify-center gap-20 p-10 md:p-16 xl:p-32 ">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 ">
        <div className="text-left space-y-2 border-2 hover:scale-105 transition-all duration-200 cursor-pointer px-8 py-10 border-sky-950 rounded-lg hover:bg-sky-50 ">
          ...
          <p className="text-sm text-gray-600">Aliqua aliqua aliquip veniam id est quis est elit labore irure id aliquip cupidatat. In qui qui magna ipsum nostrud id consequat mollit ullamco minim irure magna est ex. Ex pariatur commodo laborum irure laboris. Enim aliqua occaecat nisi quis commodo.</p>
        </div>
      </div>
    </div>
  )
